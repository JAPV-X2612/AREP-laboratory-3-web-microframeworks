...
/**
 * Simple single-threaded HTTP server that listens on port 35000,
 * handles sequential client requests, and returns a static HTML response.
 *
 * @author Jesús Pinzón
 * @version 1.0
 * @since 2026-02-24
...
public class HttpServer {
    ...
    /**
     * Application entry point. Starts the HTTP server, continuously accepts
     * client connections, parses the request line, and sends a static HTML response.
     *
    ...
    /**
     * Reads the HTTP request from the client socket, parses the request line,
     * and sends a static HTML response.
     *
